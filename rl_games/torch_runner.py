...
from rl_games.algos_torch import a2c_hybrit
...
class Runner:
    def __init__(self, algo_observer=None):
        ...
        self.algo_factory.register_builder('a2c_hybrit', lambda **kwargs: a2c_hybrit.HybritA2CAgent(**kwargs))
        ...
        self.player_factory.register_builder('a2c_hybrit', lambda **kwargs : players.PpoPlayerHybrit(**kwargs))
