...
class NetworkBuilder:
    def __init__(self):
        ...
        self.network_factory.register_builder(
            "actor_critic_transformer",
            lambda **kwargs: network_builder.TransformerA2CBuilder(),
        )
        self.network_factory.register_builder(
            "actor_critic_metamorph",
            lambda **kwargs: network_builder.MetamorphA2CBuilder(),
        )
        self.network_factory.register_builder(
            "actor_critic_mlp_dict",
            lambda **kwargs: network_builder.MLPDictA2CBuilder(),
        )
        self.network_factory.register_builder(
            "actor_critic_cnn_dict",
            lambda **kwargs: network_builder.CNNDictA2CBuilder(),
        )
        self.network_factory.register_builder(
            "actor_critic_rnn_dict",
            lambda **kwargs: network_builder.RNNDictA2CBuilder(),
        )
        self.network_factory.register_builder(
            "actor_critic_mlp_dict_thruster",
            lambda **kwargs: network_builder.MLPDictThrusterA2CBuilder(),
        )
        self.network_factory.register_builder(
            "resnet_actor_critic", lambda **kwargs: network_builder.A2CResnetBuilder()
        )
...
class ModelBuilder:
    def __init__(self):
        ...
        self.model_factory.register_builder(
            "multi_discrete_transformer_a2c",
        ...
        self.model_factory.register_builder(
            "central_value", lambda network, **kwargs: models.ModelCentralValue(network)
        )
